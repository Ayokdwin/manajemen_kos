        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="max-w-7xl mx-auto">
                    <div class="mb-6">
                        <h1 class="text-2xl font-semibold text-slate-900 dark:text-slate-100">Edit Penyewa</h1>
                        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">
                            Gunakan form di bawah ini untuk memperbarui data penyewa. Pastikan semua data yang dimasukkan sudah benar.
                        </p>
                    </div>
