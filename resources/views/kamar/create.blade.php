        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="w-full mx-auto">
                    <div class="mb-6">
                        <h1 class="text-2xl font-semibold text-slate-900 dark:text-slate-100">Tambah Kamar</h1>
                    ...
                    <form action="{{ route('kamar.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <input type="text" id="no_kamar" name="no_kamar" value="{{ old('no_kamar') }}"
                                ...
                                <div>
                                    ...
                                    <select id="tipe" name="tipe"
                                        ...
                                        @foreach (['standar', 'deluxe', 'vip'] as $tipe)
                                            <option value="{{ $tipe }}" class="capitalize"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" id="harga_per_bulan" name="harga_per_bulan"
                                        value="{{ old('harga_per_bulan') }}" placeholder="1500000" min="0"
                                        step="1000"
                            ...
                            <div>
                                ...
                                <textarea id="fasilitas" name="fasilitas" rows="3"
                                    ...
                                    class="w-full px-3.5 py-2.5 rounded-lg text-sm resize-none
                                       ...
                                       focus:ring-2 focus:ring-indigo-100 dark:focus:ring-indigo-500/20
                                       outline-none transition-colors
                                       @error('fasilitas') border-rose-300 dark:border-rose-500/50 @enderror">{{ old('fasilitas') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="deskripsi" name="deskripsi" rows="4" placeholder="Tambahkan informasi lain tentang kamar ini..."
                                    class="w-full px-3.5 py-2.5 rounded-lg text-sm resize-none
                                       ...
                                       focus:ring-2 focus:ring-indigo-100 dark:focus:ring-indigo-500/20
                                       outline-none transition-colors
                                       @error('deskripsi') border-rose-300 dark:border-rose-500/50 @enderror">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <p class="mt-1.5 text-xs text-rose-600 dark:text-rose-400">{{ $message }}</p>
                                @enderror
                            </div>
