        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="w-full mx-auto"
                    ...
                    <div class="mb-6">
                        <h1 class="text-2xl font-semibold text-slate-900 dark:text-slate-100">Buat Kontrak</h1>
                            ...
                            <div class="rounded-2xl border border-slate-200 dark:border-slate-800
                                ...
                                <div>
                                    ...
                                    <select id="user_id" name="user_id"
                                        ...
                                        <option value="" disabled {{ old('user_id') ? '' : 'selected' }}>Pilih penyewa</option>
                                ...
                                <div>
                                    ...
                                    <select id="kamar_id" name="kamar_id"
                                        ...
                                        <option value="" disabled {{ old('kamar_id') ? '' : 'selected' }}>Pilih kamar tersedia</option>
                                        @foreach ($kamar as $k)
